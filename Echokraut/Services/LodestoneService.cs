...
public class LodestoneService : ILodestoneService
{
    ...
    private async Task<string?> SearchCharacterIdAsync(string name, string world, CancellationToken ct)
    {
        ...
        {
            // HtmlAgilityPack's InnerText does NOT decode entities — names with apostrophes (common in
            // Miqo'te names) come back as "X&#39;name". HttpUtility.HtmlDecode normalizes them.
