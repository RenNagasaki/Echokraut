...
public class RemoteUrlService : IRemoteUrlService, IDisposable
{
    private const string RemoteJsonUrl =
        "https://raw.githubusercontent.com/RenNagasaki/Echokraut/main/Echokraut/Resources/RemoteUrls.json";
    ...
    private static RemoteUrlsData MergeWithFallback(RemoteUrlsData remote, RemoteUrlsData fallback)
    {
        return new RemoteUrlsData
        {
            ...
            EchokrauTtsVersion = StringOrFallback(remote.EchokrauTtsVersion, fallback.EchokrauTtsVersion),
            EchokrauTtsReleasesUrl = StringOrFallback(remote.EchokrauTtsReleasesUrl, fallback.EchokrauTtsReleasesUrl),
            EchokrauTtsEnginesUrl = StringOrFallback(remote.EchokrauTtsEnginesUrl, fallback.EchokrauTtsEnginesUrl),
            EcholinesUrl = StringOrFallback(remote.EcholinesUrl, fallback.EcholinesUrl),
            ...
            VoicePackUrl = StringOrFallback(remote.VoicePackUrl, fallback.VoicePackUrl),
            VoicePackUrls = remote.VoicePackUrls.Count > 0 ? remote.VoicePackUrls : fallback.VoicePackUrls,
        };
    }
