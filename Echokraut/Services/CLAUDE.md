...
- **Children: Samrómur Children** (CC BY 4.0, Icelandic), dev+test tarballs (~97 MB each).
  ...
  **Language mismatch is deliberate**: cloning references carry timbre, not language. If the
  Icelandic prosody bleeds through in practice, the fallback is formant-shifted young LibriTTS-R
  adults labelled "child-style" (CC BY permits adapted material).
