...
internal static class TestPaths
{
    ...
    /// <summary>
    /// Path to <c>Echokraut/Resources/Engines.json</c> in the source tree — the offline fallback for
    /// the wrapper's engine catalog.
    /// </summary>
    public static string EnginesJsonPath { get; } = ResolveRepoFile("Echokraut/Resources/Engines.json");
